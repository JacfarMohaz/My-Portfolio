...
function Chalenges() {
    return <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 md:max-[800px]:grid-cols-2 sm:gap-4 gap-10 mt-10 sm:pl-0 pl-11">
            ...
            {/* three */}
            <div className="bg-white p-4 rounded-lg shadow-lg shadow-black w-80 border-4 border-[#e9bf69] sm:ml-8 md:max-[800px]:ml-10">
