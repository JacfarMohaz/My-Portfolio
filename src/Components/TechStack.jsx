function TechStack() {
    return <div>
        <h1 className="text-4xl text-white font-bold text-center mt-10 md:mb-5 mb-10">Tech <span className="text-[#b17940]">Stack</span></h1>
        <div className="grid grid-cols-2 md:grid-cols-4 md:gap-4 gap-6 mt-10 sm:pl-40 md:max-[800px]:pl-10 pl-10">
            <div className="w-32 rounded-lg border-2 text-[#b17940] border-[#b17940] hover:bg-[#e9bf69] hover:text-white cursor-pointer">
