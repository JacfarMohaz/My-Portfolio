...
function Projects() {
    return <div id="projects">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 md:min-[800px]:grid-cols-2 sm:gap-4 gap-10 mt-10 sm:pl-0 pl-11">
            <div className="bg-white p-4 rounded-lg shadow-lg shadow-black w-80 border-4 border-[#e9bf69] sm:ml-28 md:min-[800px]:ml-10 cursor-pointer transition-all duration-500 hover:scale-110">
            ...
            {/* two */}
            <div className="bg-white p-4 rounded-lg shadow-lg shadow-black w-80 border-4 border-[#e9bf69] sm:ml-20 md:min-[800px]:ml-4 cursor-pointer transition-all duration-500 hover:scale-110">
            ...
            {/* three */}
            <div className="bg-white p-4 rounded-lg shadow-lg shadow-black w-80 border-4 border-[#e9bf69] sm:ml-10 md:min-[800px]:ml-10 cursor-pointer transition-all duration-500 hover:scale-110">
